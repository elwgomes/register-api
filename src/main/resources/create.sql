...
create table tb_users (address_id uuid unique, id BINARY(16) not null, cep varchar(255) not null, email varchar(255) not null, firstname varchar(255), lastname varchar(255), password varchar(255) not null, username varchar(255) not null, primary key (id));
